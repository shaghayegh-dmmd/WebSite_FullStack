...
(function( $, undefined ) {
    ...
    function Datepicker() {
        ...
        this._defaults = { // Global defaults for all the date picker instances
            ...
            yearRange: 'c-99:c+20', // Range of years to display in drop-down,
    ...
    $.extend(Datepicker.prototype, {
	   ...
	   @return Date - the current date */
        ...
        _doKeyPress: function (event) {
            ...
            var currentDateElement = $("#" + event.currentTarget.id);
            var validChar = new RegExp('^[0-9۰-۹/]');
            if (validChar.test(event.key)) {
                return;
            } else {
                //currentDateElement[0].value = "";

                $(currentDateElement[0]).val(function (index, value) {
                    return value.replace(/[a-zA-Zآ-ی \.\,\+\*\\\\\?\-\ء]/g, '');
                });
            }
        },
        ...
        _doKeyUp: function(event) {
            ...
            if (validChar.test(event.key)) {
                ...
                //.text($("#" + event.currentTarget.id).text().replace(/[a-zA-Zآ-ی \.\,\+\-\ء]/g, ''));
                //currentDateElement[0].value = "";
	 ...
	 */
        ...
        _generateHTML: function(inst) {
            ...
            var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
                ...
                ' title="' + prevText + '">' + (isRTL ? '<i class="glyphicon glyphicon-chevron-right"></i>' : '<i class="glyphicon glyphicon-chevron-left"></i>') + '</a>' :
                (hideIfNoPrevNext ? '' : '<a class="ui-datepicker-prev btn btn-link ui-state-disabled" title="'+ prevText +'">' + (isRTL ? '<i class="glyphicon glyphicon-chevron-right"></i>' : '<i class="glyphicon glyphicon-chevron-left"></i>') + '</a>'));
            ...
            var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
                ...
                ' title="' + nextText + '">' + (isRTL ? '<i class="glyphicon glyphicon-chevron-left"></i>' : '<i class="glyphicon glyphicon-chevron-right"></i>') + '</a>' :
                (hideIfNoPrevNext ? '' : '<a class="ui-datepicker-next btn btn-link ui-state-disabled" title="'+ nextText + '">' + (isRTL ? '<i class="glyphicon glyphicon-chevron-left"></i>' : '<i class="glyphicon glyphicon-chevron-right"></i>') + '</a>'));
