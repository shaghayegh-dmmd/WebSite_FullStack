...
(function() {
    !function(e, t) {
        kendo.ui.FlatColorPicker&&(kendo.ui.FlatColorPicker.prototype.options.messages=e.extend(!0, kendo.ui.FlatColorPicker.prototype.options.messages, {
            ...
            sortAscending: "مرتب سازی صعودی", sortDescending: "مرتب سازی نزولی", filter: "فیلتر", columns: "ستون ها", done: "تمام", settings: "تنظیمات ستون ها", lock: "بستن", unlock: "باز کردن"
        }
            ...
            string: {
                eq: "برابر باشد با", neq: "برابر نباشد با", startswith: "شروع شود با", contains: "شامل باشد", doesnotcontain: "شامل نباشد", endswith: "پایان یابد با", isnull: "null باشد", isnotnull: "null نباشد", isempty: "خالی باشد", isnotempty: "خالی نباشد"
            }
            , number: {
                eq: "برابر باشد با", neq: "برابر نباشد با", gte: "برابر یا بزرگتر باشد از", gt: "بزرگتر باشد از", lte: "کمتر و یا برابر باشد با", lt: "کمتر باشد از", isnull: "null باشد", isnotnull: "null نباشد"
            }
            , date: {
                eq: "برابر باشد با", neq: "برابر نباشد با", gte: "بعد از یا هم زمان باشد با", gt: "بعد از", lte: "قبل از یا هم زمان باشد با", lt: "قبل از", isnull: "null باشد", isnotnull: "null نباشد"
            }
            , enums: {
                eq: "برابر باشد با", neq: "برابر نباشد با", isnull: "null باشد", isnotnull: "null نباشد"
            }
        }
            ...
            info: "ردیف های را نشان بده که:", isTrue: "درست باشد", isFalse: "درست نباشد", filter: "فیلتر", clear: "پاک‌کردن", and: "و", or: "یا", selectValue: "-انتخاب مقدار-", operator: "عملگر", value: "مقدار", cancel: "انصراف"
        }
            ...
            checkAll: "انتخاب همه", clear: "پاک‌کردن", filter: "فیلتر"
        }
        )), kendo.ui.Gantt&&(kendo.ui.Gantt.prototype.options.messages=e.extend(!0, kendo.ui.Gantt.prototype.options.messages, {
            actions: {
                addChild: "اضافه کردن فرزند", append: "اضافه کردن کار", insertAfter: "اضافه کن زیر", insertBefore: "اضافه کن بالای", pdf: "گرفتن خروجی PDF"
            }
            , cancel:"انصراف", deleteDependencyWindowTitle:"حذف رابطه", deleteTaskWindowTitle:"حذف کار", destroy:"حذف", editor: {
                assingButton: "ارجاع دادن", editorTitle: "کار", end: "پایان", percentComplete: "پیشرفت", resources: "منابع", resourcesEditorTitle: "منابع", resourcesHeader: "منابع", start: "شروع", title: "عنوان", unitsHeader: "واحدها"
            }
            , save:"ذخیره", views: {
                day: "روز", end: "پایان", month: "ماه", start: "شروع", week: "هفته", year: "سال"
            }
        }
        )), kendo.ui.Grid&&(kendo.ui.Grid.prototype.options.messages=e.extend(!0, kendo.ui.Grid.prototype.options.messages, {
            commands: {
                cancel: "انصراف", canceledit: "انصراف", create: "اضافه کردن ردیف جدید", destroy: "حذف", edit: "ویرایش", excel: "خروجی Excel", pdf: "خروجی PDF", save: "ذخیره", select: "انتخاب", update: "ذخیره"
            }
            , editable: {
                cancelDelete: "انصراف", confirmation: "آیا از حذف این ردیف مطمئنید؟", confirmDelete: "حذف"
            }
            ...
            allPages:"همه", display:"ردیف {0} تا {1} از {2} ردیف", empty:"ردیفی برای نمایش وجود ندارد", page:"صفحه", of:"از {0}", itemsPerPage: "ردیف های هر صفحه", first: "برو به صفحه اول", previous: "برو به صفحه قبل", next: "برو به صفحه بعد", last: "برو به صفحه آخر", refresh: "بارگزاری مجدد", morePages: "صفحات بیشتر"
        }
            ...
            frequencies: {
                never: "هیچ وقت", hourly: "ساعتی", daily: "روزانه", weekly: "هفتگی", monthly: "ماهانه", yearly: "سالیانه"
            }
            , hourly: {
                repeatEvery: "تکرار کن هر: ", interval: " ساعت"
            }
            , daily: {
                repeatEvery: "تکرار کن هر: ", interval: " روز"
            }
            , weekly: {
                interval: " هفته", repeatEvery: "تکرار کن هر: ", repeatOn: "تکرار کن در: "
            }
            , monthly: {
                repeatEvery: "تکرار کن هر: ", repeatOn: "تکرار کن در: ", interval: " ماه", day: "روز "
            }
            , yearly: {
                repeatEvery: "تکرار کن هر: ", repeatOn: "تکرار کن در: ", interval: " سال", of: " از "
            }
            , end: {
                label: "پایان:", mobileLabel: "پایان", never: "هیچ وقت", after: "بعد از ", occurrence: " دفعات وقوع", on: "در "
            }
            , offsetPositions: {
                first: "اول", second: "دوم", third: "سوم", fourth: "چهارم", last: "آخر"
            }
            , weekdays: {
                day: "روز", weekday: "روز هفته", weekend: "پایان هفته"
            }
        }
            ...
            increaseButtonTitle: "افزایش", decreaseButtonTitle: "کاهش"
        }
        )), kendo.ui.TreeList&&(kendo.ui.TreeList.prototype.options.messages=e.extend(!0, kendo.ui.TreeList.prototype.options.messages, {
            noRows:"ردیفی برای نمایش موجود نیست", loading:"در حال بارگزاری...", requestFailed:"شکست در انجام درخواست.", retry:"تلاش مجدد", commands: {
                edit: "ویرایش", update: "ذخیره", canceledit: "انصراف", create: "درج ردیف جدید", createchild: "درج گره جدید", destroy: "حذف", excel: "خروجی Excel", pdf: "خروجی PDF"
            }
        }
            ...
            required:"{0} اجباری است", pattern:"{0} معتبر نیست", min:"{0} باید بزرگتر یا برابر باشد با {1}", max:"{0} باید کوچکتر یا برابر باشد با {1}", step:"{0} معتبر نیست", email:"{0} یک ایمیل معتبر نیست", url:"{0} آدرس وب سایت معتبر نیست", date:"{0} تاریخ معتبر نیست", dateCompare: "تاریخ پایان باید برابر یا بعد از تاریخ آغاز باشد"
        }
        ))
    }
    (window.kendo.jQuery)
